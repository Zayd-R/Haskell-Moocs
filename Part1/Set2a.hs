...
safeIndex xs i = if valid_index then Nothing else Just( (!!) xs i) 
                where size  = length xs
                      valid_index = size <=  i || i < 0
...
addEithers (Right v1) (Right v2) = Right(v1 + v2)  
addEithers (Right v1) (Left v2) = Left v2
addEithers (Left v1) (Right v2) = Left v1
addEithers (Left v1) (Left v2) = Left v1